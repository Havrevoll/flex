...
#line 1082 "fb3-1.tab.c"
    break;

  case 4: /* calclist: calclist EOL  */
#line 30 "fb3-1.y"
               { printf("> "); }
#line 1088 "fb3-1.tab.c"
    break;

  case 6: /* exp: exp '+' factor  */
#line 34 "fb3-1.y"
                 { (yyval.a) = newast('+', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1094 "fb3-1.tab.c"
    break;

  case 7: /* exp: exp '-' factor  */
#line 35 "fb3-1.y"
                 { (yyval.a) = newast('-', (yyvsp[-2].a), (yyvsp[0].a)); }
#line 1100 "fb3-1.tab.c"
    break;

  case 9: /* factor: factor '*' term  */
#line 39 "fb3-1.y"
                  { (yyval.a) = newast('*', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1106 "fb3-1.tab.c"
    break;

  case 10: /* factor: factor '/' term  */
#line 40 "fb3-1.y"
                  { (yyval.a) = newast('/', (yyvsp[-2].a),(yyvsp[0].a)); }
#line 1112 "fb3-1.tab.c"
    break;

  case 11: /* term: NUMBER  */
#line 43 "fb3-1.y"
             { (yyval.a) = newnum((yyvsp[0].d)); }
#line 1118 "fb3-1.tab.c"
    break;

  case 12: /* term: '|' term  */
#line 44 "fb3-1.y"
           { (yyval.a) = newast('|', (yyvsp[0].a), NULL); }
#line 1124 "fb3-1.tab.c"
    break;

  case 13: /* term: '(' exp ')'  */
#line 45 "fb3-1.y"
              { (yyval.a) = (yyvsp[-1].a); }
#line 1130 "fb3-1.tab.c"
    break;
